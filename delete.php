<?php
    if(isset($_POST['invisible']))
    {
        ...
        <div class='container'̥>
            ...
            <form action = 'delete.php' method='post' autocomplete='off'>
                ...
                <button type='submit' class='btn btn-search' style='background-color: green; color: white; '>Search</button>
            </form>
            <br><br><br>
    ...
    if(isset($_POST['medicine_name']))
    {
        ...
        $sql = "SELECT * FROM `pharmacy_se`.`medicines` WHERE med_name like '%$medicine%';";
        ...
        ";
                ...
                <div>
                <label style='display: flex; flex-flow: column wrap; align-items: center;'><b>Select Quantity to delete</b></label>
                ...
                <br><br> 
                <button type='submit' class='btn-primary' style=' margin-top: 32px; display: flex; flex-flow: row wrap; align-items: center;'>Delete</button>
                </form>
                ";
            }
            else
    ...
    if(isset($_POST['medicine_id']))
    {
        ...
        $sqltest = "SELECT `available` FROM `pharmacy_se`.`medicines` WHERE med_id=$medicine_id;";
